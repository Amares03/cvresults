...
// pdf header content
pdf.image("../../assets/img/header-img.png", 0, 0, {
  height: 80,
  width: fullWidth,
});
...
pdf
  .image("../../assets/img/men1.jpg", 10, 180, {
    height: 130,
  })
  .fontSize(8)
  .text("*Photo not taken during sample collection", 20, 300);
pdf
  .image("../../assets/img/rq_link.jpg", 460, 180, {
    width: 130,
  })
  .fontSize(8)
...
pdf.moveTo(380, 430).lineTo(380, 470).strokeColor("#000").lineWidth(0).stroke();
...
pdf
  .font("Times-Bold")
  .fontSize(12)
  .text(data.testPerformedBy, 200, 595, {
    width: 200,
  });
...
pdf
  .fontSize(12)
  .text(data.testMethod, 200, 635, {
    width: 400,
  });
// ***************************************************

// Footer ********************************************
pdf.image("../../assets/img/footer.png", 10, 720, {
  height: 100,
  width: fullWidth - 25,
});
pdf
